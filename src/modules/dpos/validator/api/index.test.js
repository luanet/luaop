...
describe('API: LSK Delegates', () => {
  ...
  describe('getDelegate', () => {
    ...
    it('should return delegate data', async () => {
      ...
      await expect(delegate.getDelegate({ params, network })).resolves.toEqual(
        expectedResponse,
      );
    ...
    it('should throw when api fails', async () => {
      ...
      await expect(delegate.getDelegate(data)).rejects.toEqual(
        expectedResponse,
      );
    });
  });
  ...
  describe('getDelegates', () => {
    ...
    it('should return delegates list when addressList is passed and call through websocket', async () => {
      ...
      await expect(delegate.getDelegates(data)).resolves.toEqual(
        expectedResponse,
      );
    ...
    it('should return delegates list when filters are passed and call through http', async () => {
      ...
      setApiResponseData(expectedResponse, http);
      await expect(delegate.getDelegates({ params, network })).resolves.toEqual(
        expectedResponse,
      );
    ...
    it('should throw when api fails', async () => {
      ...
      await expect(delegate.getDelegates({ addressList })).rejects.toEqual(
        expectedResponse,
      );
      await expect(
  ...
  describe('getVotes', () => {
    ...
    it('should throw when api fails', async () => {
      const expectedResponse = new Error('API call could not be completed');
      setApiRejection(expectedResponse.message, http);
      await expect(delegate.getVotes({ address })).rejects.toEqual(
        expectedResponse,
      );
    });
  });
  ...
  describe('getVoters', () => {
    ...
    it('should return votes list when address is passed', async () => {
      ...
      const params = { address };
      setApiResponseData(expectedResponse, http);
      await expect(delegate.getVoters({ params, network })).resolves.toEqual(
        expectedResponse,
      );
      expect(http).toHaveBeenCalledWith({
        baseUrl: undefined,
    ...
    it('should throw when api fails', async () => {
      const expectedResponse = new Error('API call could not be completed');
      setApiRejection(expectedResponse.message, http);
      await expect(delegate.getVoters({ address })).rejects.toEqual(
        expectedResponse,
      );
    });
  });
