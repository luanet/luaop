					...
					"end-to-end": {
						...
						nvm(getNodejsVersion()) {
							wrap([$class: 'Xvfb']) {
								...
								rm -rf ~/.lisk/
								install -D test/e2e_fixture/genesis_block.json ~/.lisk/lisk-core/config/devnet/genesis_block.json
								./lisk-core/bin/lisk-core blockchain:import --force test/e2e_fixture/blockchain.db.tar.gz
								./lisk-core/bin/lisk-core forger-info:import --force test/e2e_fixture/forger.db.tar.gz
